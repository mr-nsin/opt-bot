...
/** Positions: getAll, close(symbol), closeAll, closeAllCalls, closeAllPuts */
export const positions = {
  ...
  closeAllCalls: () => invoke<string>("close_all_calls_positions"),
  closeAllPuts: () => invoke<string>("close_all_puts_positions"),
};
