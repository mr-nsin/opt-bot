...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.pushButton.setGeometry(QtCore.QRect(20, 60, 80, 40))
        font = QtGui.QFont()
        font.setPointSize(11)
...
"color: rgb(0, 0, 0);")
        ...
        print(self.returnLoadValues)

        self.pushButton_2 = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_2.setGeometry(QtCore.QRect(239, 60, 80, 61))
        font = QtGui.QFont()
        font.setPointSize(11)
...
"color: rgb(0, 0, 0);")
    ...
    def save_data(self):
        ...
        dataDisplay = dataToDisplay.format(stocks_list, expiry, timer_in_order, spy_qqq_expiry, contract_amount, PnL, tradesTaken, openTrades, bot_startTime, bot_endTime, vwap_value, order_timer, candle_time, order_transmit, call_delta, put_delta, vol_check, atr_check, active_vol, gap_in_trades)
...
class Runnable(QRunnable):
    def __init__(self, returnValues):
        ...
        # pprint(data)
        # print('f'*10)
        # thread =Thread(target=main_call, args=(data,))
        # thread.start()
        # thread.join()
