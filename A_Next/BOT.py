...
def getCallPutEngulfCheck(stock):
    ...
    if candle_6_close >= candle_5_close and (candle_5_close >= candle_4_open or candle_5_close >= candle_4_high) and candle_4_close <= candle_3_close and \
        candle_5_vol >=candle_4_vol*0.8 and candle_5_vol <candle_4_vol*2.25:
    ...
    elif candle_6_close >= candle_5_close and (candle_5_close >= candle_4_open or candle_5_close >= candle_4_high) and candle_4_close <= candle_3_close and \
        candle_5_vol >=candle_4_vol*2.25:
    ...
    elif (candle_6_close >= candle_5_open or candle_6_close >= candle_5_high) and candle_5_close <= candle_4_close and candle_4_close <= candle_3_close and \
        candle_6_vol >=candle_5_vol*0.75 and candle_6_vol <candle_5_vol*2.25:
        ...
        candle_6_vol >=candle_5_vol*2.25:
        ...
        (candle_5_high-candle_5_open<=candle_5_close-candle_5_open*0.75) and (((candle_3_close-candle_4_close)/candle_4_close)*100)<=0.2 and \
        (candle_5_vol >=candle_4_vol*0.9 and candle_5_vol <=candle_4_vol*1.5):
        ...
        candle_4_open >= candle_4_close and (candle_3_close-candle_4_close)/candle_4_close*100 <=0.3 and \
        (candle_5_vol >= candle_4_vol*0.8 and candle_5_vol < candle_4_vol*1.5 and candle_6_vol >=candle_4_vol*0.9):
        ...
        candle_4_open >= candle_4_close and (candle_3_close-candle_4_close)/candle_4_close*100 <=0.3 and \
        (candle_5_vol > candle_4_vol*1.5 and candle_6_vol >=candle_4_vol*0.75):
        ...
        candle_3_open >= candle_3_close and (candle_2_close-candle_3_close)/candle_3_close*100 <=0.5 and \
        ...
        (candle_6_vol >= candle_3_vol*0.67 and candle_4_vol >= candle_3_vol*0.65 and candle_5_vol <= candle_3_vol*0.6):
...
def getATRValue(stock, candlesData, days=10):
    formatList = []
    from datetime import datetime
...
def checkAlgoAndTrade(Stock, Right, onlyAtrCheck="no"):
    ...
    getCandlesData = client.get_bars(stock=Stock, barSize=candleTime, limit="day")
    ...
    if onlyAtrCheck == "no":
        ...
        if candleTime == "3 mins":
            ...
            ema_S = indi.EMA_8_13_21(Stock, period="2d", interval="5m")
        else:
            ema_S = indi.EMA_8_13_21(Stock, period="2d", interval="15m")
        # FOR INTRADAY
                        ...
                        if deltaValue >= CALL_DELTA_CHECK and volumes >= VOLUME_CHECK:
                            ...
                            if toTrade and ("heavy" in signalStrength.lower() or "strong" in signalStrength.lower()):
                                ...
                                if orderData == "orderPlaced":
                                    ...
                                    continue
                            elif toTrade and "medium" in signalStrength.lower() and (ema_S_21 - ema_S_8 >= atrValue/2) and (ema_S_21 - ema_S_8 <= atrValue):
                                ###### SCLAP HIT
                                orderData = takeTrade(atrVale=atrValue, 
                                                        stock_symbol=stockName,
                                                        strike=eachStrike, 
                                ...
                                if orderData == "orderPlaced":
                                    ...
                                    dataReturn = orderData
                                    continue
                            elif toTrade and "medium" in signalStrength.lower() and (ema_S_21 - ema_S_8 >= atrValue/3) and (ema_S_21 - ema_S_8 <= atrValue):
                                ###### SCLAP HIT
                                orderData = takeTrade(atrVale=atrValue, 
                                                        stock_symbol=stockName,
                                                        strike=eachStrike, 
                                ...
                                if orderData == "orderPlaced":
                                    ...
                                    dataReturn = orderData
                                    continue
                            elif toTrade and "normal" in signalStrength.lower() and (ema_S_21 >= ema_S_13 and ema_S_13 <= ema_S_8 or ema_S_21 >= ema_S_13 and ema_S_13 >= ema_S_8):
                                ###### INTRADAY HIT
                                orderData = takeTrade(atrVale=atrValue, 
                                                        stock_symbol=stockName,
                                                        strike=eachStrike, 
                        ...
                        if deltaValue <= PUT_DELTA_CHECK and volumes >= VOLUME_CHECK:
                            ...
                            if toTrade and ("heavy" in signalStrength.lower() or "strong" in signalStrength.lower()):
                                ...
                                if orderData == "orderPlaced":
                                    ...
                                    dataReturn = orderData
                                    continue
                            elif toTrade and "medium" in signalStrength.lower() and ((ema_S_21>=ema_S_13 and ema_S_13<=ema_S_8) or (ema_S_21<=ema_S_13 and ema_S_13>=ema_S_8)):  
                                orderData = takeTrade(atrVale=atrValue, 
                                                        stock_symbol=stockName,
                                                        strike=eachStrike, 
                                                        right="PUT",
                                ...
                                if orderData == "orderPlaced":
                                    ...
                                    dataReturn = orderData
                                    continue
                            elif toTrade and "normal" in signalStrength.lower() and (ema_S_21>=ema_S_13 and ema_S_13<=ema_S_8 and ema_S_21-ema_S_13 >= atrValue/2):
                                ###### INTRADAY HIT
                                orderData = takeTrade(atrVale=atrValue, 
                                                        stock_symbol=stockName,
                                                        strike=eachStrike, 
                                ...
                                if orderData == "orderPlaced":
                                    ...
                                    dataReturn = orderData
                                    continue
                            elif toTrade and ("normal" in signalStrength.lower() or "medium" in signalStrength.lower()) and (ema_S_21>=ema_S_13 and ema_S_13>=ema_S_8):
                                ###### INTRADAY HIT
                                orderData = takeTrade(atrVale=atrValue, 
                                                        stock_symbol=stockName,
                                                        strike=eachStrike, 
...
def takeTrade(atrVale:float, stock_symbol: str, expiry: str, strike: float, right: str, options_tick: Tick, stock_tick: Tick):
    ...
    if atrVale <= 0.01:
        ...
        if atrVale < 0.235:
            ...
            if marketTime >= "1201":
                if TimeDecayDiffVal >=4:
                    timeDiffMultiplyVal = 0.82
                elif TimeDecayDiffVal < 4 and TimeDecayDiffVal >=2:
                    timeDiffMultiplyVal = 0.72
                elif TimeDecayDiffVal < 2 and TimeDecayDiffVal >0:
                    timeDiffMultiplyVal = 0.62
                profitPrice = round(tradePrice + float(atrVale * timeDiffMultiplyVal), 2)
            elif marketTime < "1201":
                if TimeDecayDiffVal >=4:
                    timeDiffMultiplyVal = 0.92
                elif TimeDecayDiffVal < 4 and TimeDecayDiffVal >=2:
                    timeDiffMultiplyVal = 0.7
                elif TimeDecayDiffVal < 2 and TimeDecayDiffVal >0:
        ...
        if atrVale < 0.235:
            if TimeDecayDiffVal >=4:
                timeDiffMultiplyVal = 1.1
            elif TimeDecayDiffVal < 4 and TimeDecayDiffVal >=2:
                 timeDiffMultiplyVal = 0.9
            elif TimeDecayDiffVal < 2 and TimeDecayDiffVal >0:
                timeDiffMultiplyVal = 0.8
...
def fetch_all_strike_expiries():
    logger.info(f"Fetching All strikes/Expiries List for all stocks. = {stockList}")
